...
// Created by jinhoesperas@gamil.com
// https://github.com/Jxino/C-Generic.git
...
typedef struct Map { // Generic HashMap
    ...
    char* K_desc; // Key type description, "i", "c", "s", "p"
    size_t V_size; // sizeof Value type
    char* V_desc; // Value type description, "i", "c", "s", "p"
    Iterator* iter;
} Map;
